...
public class UserSecond extends JFrame implements ActionListener, Runnable{
    ...
    UserSecond(){
       ...
       ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("group/chatting/application/icons/new123.png"));
       ...
       JLabel l3 = new JLabel("Friend's Club");
       l3.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
       l3.setForeground(Color.WHITE);
       l3.setBounds(100, 25, 100, 15);
       p1.add(l3);   
       
       
       JLabel l4 = new JLabel("Zahid, Nazmul, Shovon,Sazzad , Nayeem");
       l4.setFont(new Font("SAN_SERIF", Font.PLAIN, 14));
       l4.setForeground(Color.WHITE);
       l4.setBounds(115, 40, 200, 20);
       p1.add(l4);   
